...
ArUco alignment in the pipeline · detection accuracy measured against hand-labelled liner photos · BioCLIP/flatbug run on real photos · v1 classifier training ·
